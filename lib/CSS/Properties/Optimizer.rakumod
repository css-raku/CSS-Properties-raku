...
Objects of this class can be used stand-alone to optimize AST trees. The easiest
way of creating an object is to create a L<CSS::Properties> object, then dereference
the optimizer:
