...
unit class CSS::Properties::PropertyInfo;
...
my class Edges {
    has CSS::Properties::PropertyInfo $.top is required;
    has CSS::Properties::PropertyInfo $.left is required;
    has CSS::Properties::PropertyInfo $.bottom is required;
    has CSS::Properties::PropertyInfo $.right is required;
}
